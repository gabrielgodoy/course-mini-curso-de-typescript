class UserAccount {
  // A propriedade é livre para ser usada, pública
  public name: string
...
console.log(will) // UserAccount { name: 'Gabriel', age: 30 }
will.logDetails() // The player Gabriel is 30 years old.
...
class CharAccount extends UserAccount {
  ...
  // A propriedade pode ser lida/chamada nas instâncias,
...
console.log(john) // CharAccount { name: 'John', age: 45, _nickname: 'johnmaster', charType: 'aventureiro', level: 80 }

console.log(john.level) // 80
john.logDetails()
john.logCharDetails()
